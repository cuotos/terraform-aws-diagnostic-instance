...
| <a name="input_additional_user_data"></a> [additional\_user\_data](#input\_additional\_user\_data) | Additional code to be added to the user\_data.sh script | `string` | `""` | no |
